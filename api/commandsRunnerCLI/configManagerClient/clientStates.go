...
func (cmc *ConfigManagerClient) GetStates(extensionName string, status string) (string, error) {
	data, err := cmc.getRestStates(extensionName, status)
	if err != nil {
		return "", err
	}
...
//Set a state file
func (cmc *ConfigManagerClient) SetStates(extensionName string, statesPath string, overwrite bool) (string, error) {
	if statesPath == "" {
...
//Set a state file
func (cmc *ConfigManagerClient) SetStatesStatuses(extensionName string, newStatus string, fromState string, fromInclude bool, toState string, toInclude bool) (string, error) {
	if newStatus == "" {
	...
	data, err = cmc.GetStates(extensionName, "")
	if err != nil {
		return "", err
	}
	return data, nil
...
func (cmc *ConfigManagerClient) InsertStateStates(extensionName string, pos int, stateName string, before bool, statePath string, insertExtensionName string) (string, error) {
...
func (cmc *ConfigManagerClient) DeleteStateStates(extensionName string, pos int, stateName string) (string, error) {
